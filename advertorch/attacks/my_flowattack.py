...
def perturb_iterative(xvar_tgt, xvar_future, yvar, predict, nb_iter, eps, eps_iter, loss_fn,
...
class PGDAttack(Attack, LabelMixin):
    ...
    def perturb(self, x, x_future, y=None):
        """
        ...
        rval = perturb_iterative(
            x, x_future, y, self.predict, nb_iter=self.nb_iter,
