...
from models import resnet, pre_act_resnet, wide_resnet, wide_resnet_3bn, resnext, resnext_3bn, densenet
...
def generate_model(opt):
    ...
    assert opt.model_name in ['resnet', 'preresnet', 'wideresnet', 'wideresnet_3bn', 'resnext', 'resnext_3bn', 'densenet']
    ...
    elif opt.model_name == 'resnext_3bn':
    ...
    elif opt.model_name == 'wideresnet_3bn':
        assert opt.model_depth in [50]
