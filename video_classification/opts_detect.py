...
def parse_opts():
    ...
    parser.add_argument('--input', default='/home/sylo/SegNet/3D-ResNets-PyTorch/video_classification/ucfTrainTestlist/testlist01_jpg.txt', type=str, help='Input file path')
    ...
    parser.add_argument(  # /home/sylo/SegNet/3D-ResNets-PyTorch/video_classification/resnet-50-kinetics.pth
        ...
        '--pretrain_path', default='/home/sylo/SegNet/3D-ResNets-PyTorch/my_train/multi_clean_pgd_roa3/save_5.pth', type=str, help='Pretrained model (.pth)')
    parser.add_argument(  # /home/sylo/SegNet/3D-ResNets-PyTorch/video_classification/detect_train/resnet50/save_4.pth
        ...
        '--detector_path', default='/home/sylo/SegNet/3D-ResNets-PyTorch/video_classification/detect_train/resnet50/save_4.pth', type=str, help='detector model (.pth)')        
